...
Ledning: ställ upp tre ekvationer (de två jämvikterna samt mängden
järnatomers bevarande) uttryckt i de tre okända järnhalterna. Lös
approximativt för hand eller med exempelvis Matlab eller WolframAlpha.
}
