\begin{table}
  ...
  \begin{tabular}{r@{}c@{}rcl@{}c@{}rrc@{}Sc}
    \ce{Fe^3+}    & + & 2 \ce{SCN-} & $\rightleftharpoons$ & \ce{Fe(SCN)_2^+} &   &          & $\log_{10}(\beta_2)$   &=&  3.34  +- 0.02   & Ref.\cite{bahta_critical_1997} \\
    \ce{Fe^3+} & + & 3 \ce{SCN-} & $\rightleftharpoons$ & \ce{Fe(SCN)3}    &   &          & $\log_{10}(\beta_3)$   &=&  3.82  +- 0.09   & Ref.\cite{bahta_critical_1997} \\
